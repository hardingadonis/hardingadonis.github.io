type WorkExperienceItemProps = {
	worikExperience: WorkExperienceInfo;
};
			...
			<li className="mb-10 ml-4">
				...
				<p className="flex flex-wrap gap-4 flex-row items-center justify-start text-xs md:text-sm">
					<span className="inline-block px-2 py-1 font-semibold text-white bg-stone-900">
						{props.worikExperience.year}
					</span>
					<h3 className="text-lg font-semibold text-stone-900">
						{props.worikExperience.position}
					</h3>
					<div className="my-1 text-sm font-normal leading-none text-stone-400">
						{props.worikExperience.duration}
					</div>
				</p>
				<p className="my-2 text-base font-normal text-stone-500">
					<strong>Company:</strong> {props.worikExperience.company}
				</p>
				{props.worikExperience.description && (
					<p className="my-2 text-base font-normal text-stone-500">
						{props.worikExperience.description}
					</p>
				)}
